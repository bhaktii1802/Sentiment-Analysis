...
def clean_text(text):
    """Cleans text by lowercasing, removing stopwords, and applying lemmatization."""
...
def home():
    ...
    return render_template("index.html", result=result, confidence=round(confidence * 100, 2) if confidence is not None else None)
